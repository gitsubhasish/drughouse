...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/home') }}">
            ...
            <div class="sidebar-brand-text mx-3">Drug House<sup></sup></div>
        </a>
        ...
        <!-- Nav Item - Profile -->
        <li class="nav-item {{ Nav::isRoute('admin.categories.index') }}">
        ...
        <!-- Nav Item - About -->
        <li class="nav-item {{ Nav::isRoute('admin.manufacturers.index') }}">
        ...
        <li class="nav-item {{ Nav::isRoute('admin.orders.index') }}">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Maintained by <a href="#" target="_blank">Drughouse</a>. {{ now()->year }}</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
