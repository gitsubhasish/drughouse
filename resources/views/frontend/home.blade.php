...
@section('content')
    ...
    <div class="owl-carousel owl-single px-0">
      <div class="site-blocks-cover overlay" style="background-image: url('{{ asset('pharmative/images/hero_bg.jpg') }});">
        <div class="container">
          <div class="row">
        ...
        <div class="row justify-content-between">
          <div class="col-lg-6">
            ...
            <div class="owl-single no-direction owl-carousel">
              ...
              <div class="testimony">
                <blockquote>
                  <img src="{{ asset('pharmative/images/person_1.jpg') }}" alt="Image" class="img-fluid">
              ...
              <div class="testimony">
                <blockquote>
                  <img src="{{ asset('pharmative/images/person_2.jpg') }}" alt="Image" class="img-fluid">
              ...
              <div class="testimony">
                <blockquote>
                  <img src="{{ asset('pharmative/images/person_3.jpg') }}" alt="Image" class="img-fluid">
                  <p>&ldquo;Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo omnis voluptatem consectetur quam tempore
                    obcaecati maiores voluptate aspernatur iusto eveniet, placeat ab quod tenetur ducimus. Minus ratione sit quaerat
                    unde.&rdquo;</p>
                </blockquote>
              ...
              <div class="testimony">
                <blockquote>
                  <img src="{{ asset('pharmative/images/person_4.jpg') }}" alt="Image" class="img-fluid">
                  <p>&ldquo;Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo omnis voluptatem consectetur quam tempore
                    obcaecati maiores voluptate aspernatur iusto eveniet, placeat ab quod tenetur ducimus. Minus ratione sit quaerat
                    unde.&rdquo;</p>
                </blockquote>
